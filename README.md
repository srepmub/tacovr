...
131nm of torque, or something close to it, may be achievable with the most expensive NEMA56 servo motor (about 12Nm) and a 10:1 gear reducer. this would be quite expensive though and we would get in trouble with the max RPM (goes down by a factor of 10 with this gear reducer).
